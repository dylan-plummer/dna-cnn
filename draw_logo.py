...
def draw_A(width, height,x,y, ax, color="blue",lw=1.0,alpha=0.5):
    ...
    return y+height
def draw_T(width, height,x,y, ax, color="red",lw=1.0,alpha=0.5):
    center  = width*0.5
    ...
    return y+height
def draw_C(width, height,x,y, ax, color="green",lw=1.0,alpha=0.5):
    width/=2.0
    x       += width
...
def draw_G(width, height,x,y, ax, color="orange",lw=1.0,alpha=0.5):
    width/=2.0
    x       += width
...
def draw_seq_log(PSSM,title, AX=None,lw=2.0,alpha=1):
    ax      = AX
